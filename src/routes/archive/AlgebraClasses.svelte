...
<Heading text="Algenra: Pricing" size={2} textColor="#1B9AAA" />
<div style="margin-left: 10vw; margin-right: 10vw;">
    <PanelBox>
...
<Heading text="Algebra: Weekly Schedule" size={2} textColor="#1B9AAA" />
...
<Heading text="Algebra: Classes Schedule" size={2} textColor="#1B9AAA" />
<div class="schedule-wrapper">
    <FlexBox>
        <PanelBox>
            <!-- svelte-ignore missing-declaration -->
